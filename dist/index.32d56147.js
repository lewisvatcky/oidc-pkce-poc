...
})({"fCmof":[function(require,module,exports) {
...
var $b4te3$oidcclientts = require("230b62866bd9a579");
const $a196c1ed25598f0e$var$user = new $b4te3$oidcclientts.UserManager({
...
},{"230b62866bd9a579":"jXrpQ"}],"jXrpQ":[function(require,module,exports) {
"use strict";
...
var import_core = __toESM(require("7cc871af1cc55278"));
var import_sha256 = __toESM(require("da269a8a2908b037"));
var import_enc_base64 = __toESM(require("f624a8ec15024df8"));
var import_enc_utf8 = __toESM(require("975a82875098dc82"));
// src/utils/Logger.ts
var nopLogger = {
    debug: ()=>void 0,
    info: ()=>void 0,
...
var import_jwt_decode = __toESM(require("b8f8d62a62b69049"));
var JwtUtils = class {
...
var ResponseValidator = class {
    ...
    _validateIdTokenAttributes(response, currentToken) {
        ...
        if (!profile.sub) logger2.throw(new Error("ID Token is missing a subject claim"));
        if (currentToken) {
            const current = JwtUtils.decode(currentToken);
            if (current.sub !== profile.sub) logger2.throw(new Error("sub in id_token does not match current sub"));
            if (current.auth_time && current.auth_time !== profile.auth_time) logger2.throw(new Error("auth_time in id_token does not match original auth_time"));
            if (current.azp && current.azp !== profile.azp) logger2.throw(new Error("azp in id_token does not match original azp"));
            if (!current.azp && profile.azp) logger2.throw(new Error("azp not in id_token, but present in original id_token"));
        }
...
},{"7cc871af1cc55278":"gcdtm","da269a8a2908b037":"lNj7D","f624a8ec15024df8":"1XZVI","975a82875098dc82":"exkTk","b8f8d62a62b69049":"ljM1w"}],"gcdtm":[function(require,module,exports) {
var global = arguments[3];
(function(root, factory) {
	 ...
	 */ var CryptoJS = CryptoJS || function(Math1, undefined) {
        ...
        if (!crypto && true) try {
            crypto = require("ffc04f1c6a92a26a");
        } catch (err) {}
        /*
...
},{"ffc04f1c6a92a26a":"jhUEF"}],"jhUEF":[function(require,module,exports) {
"use strict";

},{}],"lNj7D":[function(require,module,exports) {
(function(root, factory) {
    // CommonJS
    module.exports = exports = factory(require("3ffd812507a65fad"));
...
},{"3ffd812507a65fad":"gcdtm"}],"1XZVI":[function(require,module,exports) {
(function(root, factory) {
    // CommonJS
    module.exports = exports = factory(require("446049279301307e"));
})(this, function(CryptoJS) {
    (function() {
        // Shortcuts
        var C = CryptoJS;
...
},{"446049279301307e":"gcdtm"}],"exkTk":[function(require,module,exports) {
(function(root, factory) {
    // CommonJS
    module.exports = exports = factory(require("93ab8d5279bdbd50"));
})(this, function(CryptoJS) {
    return CryptoJS.enc.Utf8;
});

},{"93ab8d5279bdbd50":"gcdtm"}],"ljM1w":[function(require,module,exports) {
...
},{}]},["fCmof","lbDgN"], "lbDgN", "parcelRequire94c2")
